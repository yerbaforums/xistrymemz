...
interface PostActionsProps {
  ...
  onReply?: () => void
  onRepostChange?: (postId: string, reposted: boolean) => void
...
export default function PostActions({ postId, postAuthorId, initialLikes, liked: initialLiked, initialSaved = false, replyCount, reposted: initialReposted = false, repostCount: initialRepostCount = 0, onLike, onTip, onReply, onRepostChange, onEdit, showTip = true }: PostActionsProps) {
        ...
        <div style={{ position: 'relative' }}>
          ...
          {showExtra && (
            <div style={{
              ...
              {isOwner && onEdit && (
                <button type="button" onClick={() => { onEdit(postId); setShowExtra(false) }}
