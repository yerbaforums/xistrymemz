        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.bottomCenter}>
            <div className={styles.socialRow}>
              ...
              <a href="https://bsky.app/profile/xistrymemz.bsky.social" target="_blank" rel="noopener noreferrer" className={styles.socialLink} title="Bluesky">
                <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.75 1.638.639 1.789.639 1.942c0 .145.104.32.276.42.897.526 2.136 1.48 3.433 2.572C6.214 6.376 7.5 8.061 8.848 9.586c.047.054.094.106.14.156-.543.319-1.091.636-1.656.947-2.24 1.234-5.312 2.92-5.312 5.745 0 1.511.946 2.611 2.412 3.228 1.758.737 3.565.771 4.613.771h.324c1.048 0 2.855-.034 4.613-.771 1.466-.617 2.412-1.717 2.412-3.228 0-2.825-3.072-4.511-5.312-5.745-.565-.311-1.113-.628-1.656-.947.046-.05.093-.102.14-.156 1.348-1.525 2.634-3.21 4.5-4.652 1.297-1.092 2.536-2.046 3.433-2.572.172-.1.276-.275.276-.42 0-.153-.111-.304-.263-.377-.659-.299-1.664-.423-4.3 1.44C16.046 4.747 13.087 8.686 12 10.8z"/></svg>
              </a>
            </div>
