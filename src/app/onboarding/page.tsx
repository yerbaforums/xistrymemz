...
const TOUR_OUTLETS = [
  ...
  { id: 'projects', icon: '🚀', name: 'Projects', description: 'Organize goals with milestones, track progress, and collaborate with others on shared projects.', url: '/projects/new' },
