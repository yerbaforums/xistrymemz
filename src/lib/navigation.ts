...
export const NAV: NavConfig = {
  ...
  explore: [
    ...
    { href: '/blogs', icon: '✍️', label: 'Blogs' },
    { href: '/podcasts', icon: '🎙️', label: 'Podcasts' },
  ...
  dashboard: [
    ...
    { href: '/dashboard/podcast', icon: '🎙️', label: 'Podcast' },
    { href: '/dashboard/events', icon: '📅', label: 'Events' },
    { href: '/dashboard/appointments', icon: '🗓️', label: 'Appointments' },
    { href: '/dashboard/planning', icon: '🗺️', label: 'Map Planning' },
...
export const STUDIO_GROUPS: { label: string; hrefs: string[] }[] = [
  { label: 'Plan & Discover', hrefs: ['/discover', '/boards', '/dashboard/planning', '/dashboard/marketplace', '/dashboard/events', '/dashboard/passport'] },
...
export const DASHBOARD_SIDEBAR: SidebarNavItem[] = [
  ...
  { href: '/dashboard/marketplace', icon: '🛒', label: 'Marketplace', section: 'secondary' },
  { href: '/dashboard/events', icon: '📅', label: 'Events', section: 'secondary' },
  { href: '/dashboard/passport', icon: '🌍', label: 'Passport', section: 'secondary' },
  ...
  { href: '/dashboard/blog', icon: '✍️', label: 'Blog', section: 'secondary' },
  { href: '/dashboard/podcast', icon: '🎙️', label: 'Podcast', section: 'secondary' },
  { href: '/dashboard/offers', icon: '🤝', label: 'Offers', section: 'secondary' },
  { href: '/dashboard/sponsorships', icon: '💝', label: 'Sponsorships', section: 'secondary' },
